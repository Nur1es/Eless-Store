    ...
    <div>
      <div className='max-w-screen-xl mx-auto my-10 flex gap-10'>
        <div className='w-full relative flex gap-10'>
            <img className='w-[500px] h-[550px] object-cover' src={details.images} alt="producttImg" />
            <div className='w-3/5 flex flex-col justify-center gap-12'>
              ...
              <div className='flex gap-4'>
                ...
                <button className='bg-black text-white py-3 px-6 active:bg-gray-800'>add to crat</button>
              </div>
